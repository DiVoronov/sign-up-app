  ...
  return (
    <ContainerShared>
      ...
      { 
        connecting 
        &&  
        <Box sx={{position: "fixed", width: {xs: "450px", sm: "100%"}, height: "900px", background: "#FFFFFF", left: "0px", top: "0px"}}>
          <Box sx={{position: "absolute", width: {xs: "450px", sm: "100%"}, height: "900px", left: {xs: "110px", sm: "45%"}, top: {xs: "200px", sm: "268px"}}}>
